...
public class PaymentController : ControllerBase
{
    ...
    [HttpGet("parameter")]
    [Authorize(Roles = "Admin")]
    public async Task<ApiResponse<List<PaymentResponse>>> GetByParameter([FromQuery] decimal? amount,
        [FromQuery] DateTime? paymentDate, [FromQuery] PaymentMethod? paymentMethod)
    {
